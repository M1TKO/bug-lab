				...
				$.ajax({
					...
					if (elements.length) {
						$.each(elements, function () {
							...
							$('#' + elementAriaDescribedby).html(elementErrorMSG.text()).closest('form').find('[aria-describedby="' + elementAriaDescribedby + '"]').addClass('is-invalid');
						});
					} else {
  ...
  */
	...
	window.preloaderInit = function (afterIn) {
		...
		preloader.from(shape_1, 0.5, {
			...
			opacity: 0,
			ease: Power3.ease
		}, "t1+=0.15").from(shape_3, 0.5, {
			opacity: 0,
			ease: Power3.ease
		}, "t1+=0.30").from(shape_4, 0.5, {
			opacity: 0,
			ease: Power3.ease
		}, "t1+=0.45").from(shape_5, 0.5, {
			opacity: 0,
			ease: Power3.ease
		}, "t1+=0.60").to(shape_1, 0.5, {
			opacity: 0,
			ease: Power3.ease
		}, "t1+=0.75").to(shape_2, 0.5, {
			opacity: 0,
			ease: Power3.ease
		}, "t1+=0.90").to(shape_3, 0.5, {
			opacity: 0,
			ease: Power3.ease
		}, "t1+=1.05").to(shape_4, 0.5, {
			opacity: 0,
			ease: Power3.ease
		}, "t1+=1.2").to(shape_5, 0.5, {
			opacity: 0,
			ease: Power3.ease
		}, "t1+=1.35");
	};
  ...
  */
   ...
   */
		communicationProtocol.add(function () {
			...
			opacity: 0
		}, "-=0.99").to(user_stroke_iLength, 1, {
			length: user_stroke_iLength.pathLength,
			onUpdate: drawUserInner,
			ease: Power3.easeOut
		}, "-=1").from(user_stroke_inner, 0.001, {
			opacity: 0
		}, "-=0.99")
		...
		.from(publisher_group, 0.5, {
			...
			opacity: 0
		}, "-=0.99").to(publisher_stroke_iLength, 1, {
			length: publisher_stroke_iLength.pathLength,
			onUpdate: drawPublisherInner,
			ease: Power3.easeOut
		}, "-=1").from(publisher_stroke_inner, 0.001, {
			opacity: 0
		}, "-=0.99")
		...
		.to(arrow_2_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(content_and_ad_placement, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
		...
		.from(bidder_group, 0.5, {
			...
			opacity: 0
		}, "-=0.99").to(bidder_stroke_iLength, 1, {
			length: bidder_stroke_iLength.pathLength,
			onUpdate: drawBidderInner,
			ease: Power3.easeOut
		}, "-=1").from(bidder_stroke_inner, 0.001, {
			opacity: 0
		}, "-=0.99")
		...
		.from(advertiser_group, 0.5, {
			...
			opacity: 0
		}, "-=0.99").to(advertiser_stroke_iLength, 1, {
			length: advertiser_stroke_iLength.pathLength,
			onUpdate: drawAdvertiserInner,
			ease: Power3.easeOut
		}, "-=1").from(advertiser_stroke_inner, 0.001, {
			opacity: 0
		}, "-=0.99")
		...
		.to(arrow_6_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(encrypted_creatives, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=1.3")
		...
		.to(arrow_7_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(decryption_wrap, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=1.3").fromTo(decryption_wrap, 2, {
			opacity: 1
		}, { opacity: 1 })
   ...
   */
		...
		.staggerFrom(oct_text, 0.5, {
			...
			ease: Power3.easeOut
		}, 0.02).from(oct_dasshed, 1, {
			opacity: 0,
			ease: Power3.easeOut
		}, "-=1").from(oct_arrow_left, 0.2, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=0.5").from(oct_arrow_right, 0.2, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=0.5").staggerFrom(oct_green_cubes, 0.5, {
			opacity: 0,
			ease: Power3.easeOut
		}, 0.01).staggerFrom(oct_blue_cubes, 0.5, {
			opacity: 0,
			ease: Power3.easeOut
		}, 0.01, "-=0.825").from(oct_bracket_left, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=0.5").from(oct_bracket_right, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=0.5").from(oct_a_sum, 0.5, {
			opacity: 0,
			scale: 0, transformOrigin: "center",
			ease: Power3.easeOut
		}, "-=0.3").from(oct_p_sum, 0.5, {
			opacity: 0,
			scale: 0, transformOrigin: "center",
			ease: Power3.easeOut
		}, "-=0.5")
		...
		.add("t1").to(arrow_8_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(daily_sum_a, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=1.3").from(hour_box_sum_a, 0.5, {
			opacity: 0,
			scale: 0, transformOrigin: "center",
			ease: Power3.easeOut
		}, "-=1.3").to(arrow_9_sLength, 1.5, {
			opacity: 1,
			length: arrow_9_sLength.pathLength,
			onUpdate: drawArr9,
			ease: Power3.easeOut
		}, "t1").from(arrow_9, 0.001, {
			opacity: 0
		}, "t1").from(daily_sum_p, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=1.3").from(hour_box_sum_p, 0.5, {
			opacity: 0,
			scale: 0, transformOrigin: "center",
			ease: Power3.easeOut
		}, "-=1.3").from(sum_a, 0.5, {
		...
		.to(arrow_10_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(rewards_initiation, 0.5, {
			opacity: 0,
			transform: "translateY(10px)",
			ease: Power3.ease
		}, "-=1.4")
		...
		.staggerFrom(blockchain_text, 0.5, {
			...
			transform: "translateY(-5px)",
			ease: Power3.easeOut
		}, 0.02).from(blockchain_dashed, 1, {
			opacity: 0,
			ease: Power3.easeOut
		}, "-=0.7").from(blockchain_dash_box, 0.2, {
			opacity: 0,
			transform: "translateY(-10px)",
			ease: Power3.easeOut
		...
		.to(arrow_11_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(hour_box_adv_spend, 0.5, {
			opacity: 0,
			scale: 0, transformOrigin: "center",
			ease: Power3.easeOut
		}, "-=1.3").from(daily_advertiser_spend, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=1.1").staggerFrom(blockchain_color_box, 0.5, {
			opacity: 0,
			transform: "translateY(-10px)",
			ease: Power3.easeOut
		}, 0.05, "-=0.8")
		...
		.from(voting_group, 0.5, {
			...
			opacity: 0
		}, "-=0.99").to(voting_stroke_iLength, 1, {
			length: voting_stroke_iLength.pathLength,
			onUpdate: drawVotingInner,
			ease: Power3.easeOut
		}, "-=1").from(voting_stroke_inner, 0.001, {
			opacity: 0
		}, "-=0.99").from(voting_result, 0.5, {
			opacity: 0,
			transform: "translateY(-10px)",
			ease: Power3.easeOut
		}, "-=0.5")
		...
		.to(arrow_12_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(hour_box_voting_rewards, 0.5, {
			opacity: 0,
			scale: 0, transformOrigin: "center",
			ease: Power3.easeOut
		}, "-=1.5").from(voting_rewards, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=1.2")
		...
		.to(arrow_13_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(hour_box_pub_payment, 0.5, {
			opacity: 0,
			scale: 0, transformOrigin: "center",
			ease: Power3.easeOut
		}, "-=1.4").from(daily_publisher_paiment, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=1.2")
		...
		.to(arrow_14_sLength, 1.5, {
			...
			onUpdate: drawArr15,
			ease: Power3.easeOut
		}, "-=1.5").from(arrow_14, 0.001, {
			opacity: 0
		}, "-=1.49").from(arrow_15, 0.001, {
			opacity: 0
		}, "-=1.49").from(individual_oct_adv, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=1.3").from(individual_oct_pub, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=1.3").fromTo(decryption_wrap, 2, {
   ...
   */
		...
		.to(arrow_16_sLength, 1.5, {
			...
			onUpdate: drawArr17,
			ease: Power3.easeOut
		}, "-=1.5").from(arrow_16, 0.001, {
			opacity: 0
		}, "-=1.49").from(arrow_17, 0.001, {
			opacity: 0
		}, "-=1.49").from(off_chain_verification_adv, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=1.3").from(off_chain_verification_pub, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=1.3")
		...
		.to(arrow_19_sLength, 1.5, {
			...
			onUpdate: drawArr20,
			ease: Power3.easeOut
		}, "-=1.5").from(arrow_19, 0.001, {
			opacity: 0
		}, "-=1.49").from(arrow_20, 0.001, {
			opacity: 0
		}, "-=1.49").from(targeting_and_budget, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=1.4").from(blacklists_and_whitelists, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=1.3")
		...
		.to(arrow_21_sLength, 1.5, {
			...
			onUpdate: drawArr22,
			ease: Power3.easeOut
		}, "-=1.5").from(arrow_21, 0.001, {
			opacity: 0
		}, "-=1.49").from(arrow_22, 0.001, {
			opacity: 0
		}, "-=1.49").from(appeals_and_deposits_adv, 0.5, {
			opacity: 0,
			transform: "translateX(-10px)",
			ease: Power3.easeOut
		}, "-=1.4").from(appeals_and_deposits_pub, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=1.5")
		...
		.to(arrow_24_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(blocklists_voting, 0.5, {
			opacity: 0,
			transform: "translateX(10px)",
			ease: Power3.easeOut
		}, "-=1.5")
		...
		.to(arrow_26_sLength, 1.5, {
			...
			opacity: 0
		}, "-=1.49").from(blocklists_blockchain, 0.5, {
			opacity: 0,
			transform: "translateY(10px)",
			ease: Power3.easeOut
		}, "-=1.5")
   ...
   */
		function fst1() {
			var ids = [
			/* user */
			'#user_x5F_outer_1_', '#user_x5F_inner_1_',
			/* publisher */
			'#pub_x5F_outer_1_', '#pub_x5F_inner_1_',
			/* bidder */
			'#bidder_x5F_outer_1_', '#bidder_x5F_inner_1_',
			/* advertiser */
			'#adv_x5F_outer_1_', '#adv_x5F_inner_1_',
			/* arrows */
			'#arrow_x5F_1_x5F_content_x5F_request_2_', '#arrow_x5F_2_x5F_content_x5F_ad_x5F_placement_2_', '#arrow_x5F_3_x5F_ad_x5F_request', '#arrow_x5F_4_x5F_ad_x5F_address_2_', '#arrow_x5F_5_x5F_ssl_2_', '#arrow_x5F_6_x5F_encrypted_x5F_creatives_2_', '#arrow_x5F_7_x5F_decryption'];
		...
		function fst2() {
			var ids = [
			/* arrows */
			'#arrow_x5F_daily_x5F_sum_x5F_advertiser', '#arrow_x5F_daily_x5F_sum_x5F_publisher', '#arrow_x5F_rewards_x5F_initiation_2_', '#arrow_x5F_daily_x5F_advertising_x5F_spend', '#arrow_x5F_voting_x5F_rewards_1_', '#arrow_x5F_daily_x5F_publisher_x5F_payment_1_', '#arrow_x5F_individual_x5F_OCT_x5F_advertiser', '#arrow_x5F_individual_x5F_OCT_x5F_publisher'];
			$(ids.join()).css('stroke-dasharray', 0);
		};
